...
class SensorGridWorld(gym.Env):
       ...
       def reset(self):
              ...
              for each in range (0,numDrone):
                     ...
                     self.grid[temp1, temp2] = 200
              self.grid[25:123,34:150] = 200
              temp = self.grid
              return temp
       ...
       def render(self, mode='console'):
              ...
              sns.heatmap(self.grid, cbar=False, cbar_ax = False, square = True, yticklabels = False, xticklabels = False, vmin=0, vmax=200, cmap="cubehelix")
